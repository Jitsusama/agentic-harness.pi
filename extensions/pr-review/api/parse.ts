 ...
 *
 * Shared logic with pr-reply/api/parse.ts. Duplicated rather
 * than extracted to a shared module because both extensions are
 * independently motivated and may diverge.
 */
