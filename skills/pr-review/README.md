...
which provides the `pr_review` tool, and the
[code-review-criteria](../code-review-criteria/) and
[conventional-comments](../conventional-comments/) skills for
evaluation guidance and comment formatting.
